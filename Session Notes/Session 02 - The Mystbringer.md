...
## TODO
- [ ] Idea of using Seeming to turn giants against each other
	- [ ] They mignt respect the [[Ordening]]
	- [ ] Need to get within 90 feet
	- [ ] No verbal component
- [ ] Major image of one of the dead frost giant zombies
## Recap
...
- Explored room to the north
	...
	- Dias with runes on the far side
		...
		- Presumably written 1000s of years ago
		- Description of cult
			- United giants of different types
